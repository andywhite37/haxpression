...
class graphx_Graph:
    ...
    def equals(self,a,b):
        return self.nodeFunctions.isEqual(graphx__NodeOrValue_NodeOrValue_Impl_.toValue(a),graphx__NodeOrValue_NodeOrValue_Impl_.toValue(b))
...
class graphx_StringGraph(graphx_Graph):
    ...
    def __init__(self):
        ...
        def _hx_local_1(a1):
            return a1
        super().__init__(_hx_AnonObject({'isEqual': _hx_local_0, 'getKey': _hx_local_1}))
