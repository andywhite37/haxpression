...
class graphx_Graph:
    ...
    def addNode(self,nv):
        if (not self.contains(nv)):
            _this = self.nodes
            x = graphx__NodeOrValue_NodeOrValue_Impl_.toNode(nv)
            _this.append(x)
        return self
    ...
    def dfs(self,visit,acc):
        ...
        def _hx_local_3(node):
            ...
            unvisitedNodes = list(map(_hx_local_0,list(filter(_hx_local_1,_gthis.getEdgesOut(graphx__NodeOrValue_NodeOrValue_Impl_.fromNode(node))))))
            def _hx_local_2(unvisitedNode,acc1):
                return dfsFromNode(unvisitedNode)
            acc = Lambda.fold(unvisitedNodes,_hx_local_2,acc)
    ...
    def bfs(self,visit,acc):
        ...
        def _hx_local_3(node):
            ...
            while (len(queue) > 0):
                ...
                def _hx_local_1(edge1):
                    return (not (_gthis.getKey(graphx__NodeOrValue_NodeOrValue_Impl_.fromNode(edge1.to)) in visited.h))
                unvisitedNodes = list(map(_hx_local_0,list(filter(_hx_local_1,_gthis.getEdgesOut(graphx__NodeOrValue_NodeOrValue_Impl_.fromNode(currentNode))))))
                def _hx_local_2(unvisitedNode):
                    queue.append(unvisitedNode)
                Lambda.iter(unvisitedNodes,_hx_local_2)
            return acc
    ...
    def clone(self):
        ...
        def _hx_local_1(edge,acc1):
            newGraph1 = graphx__NodeOrValue_NodeOrValue_Impl_.fromValue(edge._hx_from.value)
            return newGraph.addEdgeFrom(newGraph1,graphx__NodeOrValue_NodeOrValue_Impl_.fromValue(edge.to.value))
    ...
    def getKey(self,nv):
        tmp = self.nodeFunctions
        tmp1 = graphx__NodeOrValue_NodeOrValue_Impl_.toValue(nv)
        return tmp.getKey(tmp1)

    def equals(self,a,b):
        tmp = self.nodeFunctions
        tmp1 = graphx__NodeOrValue_NodeOrValue_Impl_.toValue(a)
        tmp2 = graphx__NodeOrValue_NodeOrValue_Impl_.toValue(b)
        return tmp.isEqual(tmp1,tmp2)
...
class graphx_StringGraph(graphx_Graph):
    ...
    def __init__(self):
        ...
        def _hx_local_1(a1):
            return a1
        nodeFunctions = _hx_AnonObject({'isEqual': _hx_local_0, 'getKey': _hx_local_1})
        super().__init__(nodeFunctions)
...
class haxpression__Value_Value_Impl_:
    ...
    def toBool(this1):
        ...
        if (this2 == 0):
            ...
            v3 = this1.params[0]
            return (v3.lower() == haxpression__Value_Value_Impl_.TRUE_STRING)
        elif (this2 == 4):
    ...
    def equals(this1,other):
        ...
        if (this2 == 0):
            ...
            if (_g1 == 0):
                ...
                value1 = this1.params[0]
                other2 = _g.params[0]
                return (value1 == other2)
            else:
                return False
        elif (this2 == 1):
            _g2 = _g.index
            if (_g2 == 0):
                value2 = this1.params[0]
                other3 = _g.params[0]
                tmp = None
                try:
                    tmp = int(other3)
                ...
                value3 = this1.params[0]
                other4 = _g.params[0]
                return (value3 == other4)
            else:
                return False
        elif (this2 == 2):
            if (_g.index == 2):
                value4 = this1.params[0]
                other5 = _g.params[0]
                return (value4 == other5)
            else:
                return False
        elif (this2 == 3):
            if (_g.index == 3):
                value5 = this1.params[0]
                other6 = _g.params[0]
                return (value5 == other6)
            else:
                return False
        elif (this2 == 4):
            if (_g.index == 4):
...
class haxpression_Error:
    ...
    def toString(self):
        expressionInfo = (((" in expression: \"" + HxOverrides.stringOrNull(self.expression)) + "\"") if ((self.expression is not None)) else "")
        positionInfo = ((" at position: " + Std.string(self.position)) if ((self.position is not None)) else "")
        return ((("" + HxOverrides.stringOrNull(self.message)) + ("null" if expressionInfo is None else expressionInfo)) + ("null" if positionInfo is None else positionInfo))
...
class haxpression_BinaryOperations:
    ...
    def addOperator(operator,precedence,operation):
        this1 = haxpression_BinaryOperations.map
        value = _hx_AnonObject({'precedence': precedence, 'operation': haxpression_BinaryOperations.wrapOperation(operation)})
        this1.h[operator] = value
...
class haxpression_CallOperations:
    ...
    def addFunction(callee,arity,operation):
        this1 = haxpression_CallOperations.map
        value = _hx_AnonObject({'arity': arity, 'operation': haxpression_CallOperations.wrapOperation(callee,arity,operation)})
        this1.h[callee] = value
    ...
    def evaluate(callee,arguments):
        operation = haxpression_CallOperations.getFunction(callee)
...
class haxpression__Expression_Expression_Impl_:
    ...
    def toString(this1):
        ...
        if (this2 == 0):
            value = this1.params[0]
            this3 = value
            return haxpression__Value_Value_Impl_.toString(this3)
        elif (this2 == 1):
            name = this1.params[0]
            return name
        elif (this2 == 2):
            ...
            return (("" + ("null" if operator is None else operator)) + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getString(this1,operand)))
        elif (this2 == 3):
            right = this1.params[2]
            left = this1.params[1]
            operator1 = this1.params[0]
            return (((((("(" + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getString(this1,left))) + " ") + ("null" if operator1 is None else operator1)) + " ") + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getString(this1,right))) + ")")
        elif (this2 == 4):
            arguments = this1.params[1]
            callee = this1.params[0]
            return (((("" + ("null" if callee is None else callee)) + "(") + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getStringDelimited(this1,arguments,","))) + ")")
        elif (this2 == 5):
            alternate = this1.params[2]
            consequent = this1.params[1]
            test = this1.params[0]
            return (((((("(" + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getString(this1,test))) + " ? ") + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getString(this1,consequent))) + " : ") + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getString(this1,alternate))) + ")")
        elif (this2 == 6):
            items = this1.params[0]
            return (("[" + HxOverrides.stringOrNull(haxpression__Expression_Expression_Impl_.getStringDelimited(this1,items,","))) + "]")
        elif (this2 == 7):
            items1 = this1.params[0]
            return haxpression__Expression_Expression_Impl_.getStringDelimited(this1,items1,";")
        else:
            pass
    ...
    def toDynamic(this1):
        if (this1.index == 0):
            value = this1.params[0]
            this2 = value
            return haxpression__Value_Value_Impl_.toDynamic(this2)
        else:
    ...
    def toObject(this1):
        ...
        if (this2 == 0):
            value = this1.params[0]
            this3 = value
            return _hx_AnonObject({'type': "Literal", 'value': haxpression__Value_Value_Impl_.toDynamic(this3)})
        elif (this2 == 1):
            name = this1.params[0]
            return _hx_AnonObject({'type': "Identifier", 'name': name})
        elif (this2 == 2):
            operand = this1.params[1]
            operator = this1.params[0]
            return _hx_AnonObject({'type': "Unary", 'operator': operator, 'operand': haxpression__Expression_Expression_Impl_.toObject(haxpression__Expression_Expression_Impl_.fromExpressionType(operand))})
        elif (this2 == 3):
            right = this1.params[2]
            left = this1.params[1]
            operator1 = this1.params[0]
            return _hx_AnonObject({'type': "Binary", 'operator': operator1, 'left': haxpression__Expression_Expression_Impl_.toObject(haxpression__Expression_Expression_Impl_.fromExpressionType(left)), 'right': haxpression__Expression_Expression_Impl_.toObject(haxpression__Expression_Expression_Impl_.fromExpressionType(right))})
        elif (this2 == 4):
            arguments = this1.params[1]
            callee = this1.params[0]
            return _hx_AnonObject({'type': "Call", 'callee': callee, 'arguments': haxpression_ExpressionTypes.toObject(arguments)})
        elif (this2 == 5):
            alternate = this1.params[2]
            consequent = this1.params[1]
            test = this1.params[0]
            return _hx_AnonObject({'type': "Conditional", 'test': haxpression__Expression_Expression_Impl_.toObject(haxpression__Expression_Expression_Impl_.fromExpressionType(test)), 'consequent': haxpression__Expression_Expression_Impl_.toObject(haxpression__Expression_Expression_Impl_.fromExpressionType(consequent)), 'alternate': haxpression__Expression_Expression_Impl_.toObject(haxpression__Expression_Expression_Impl_.fromExpressionType(alternate))})
        elif (this2 == 6):
            items = this1.params[0]
            return _hx_AnonObject({'type': "Array", 'items': haxpression_ExpressionTypes.toObject(items)})
        elif (this2 == 7):
            items1 = this1.params[0]
            return _hx_AnonObject({'type': "Compound", 'items': haxpression_ExpressionTypes.toObject(items1)})
        else:
            pass
    ...
    def clone(this1):
        ...
        if (this2 == 0):
            value = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.ELiteral(value))
        elif (this2 == 1):
            name = this1.params[0]
            ...
            operand = this1.params[1]
            operator = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EUnary(operator,haxpression__Expression_Expression_Impl_.toExpressionType(haxpression__Expression_Expression_Impl_.clone(haxpression__Expression_Expression_Impl_.fromExpressionType(operand)))))
        elif (this2 == 3):
            right = this1.params[2]
            left = this1.params[1]
            operator1 = this1.params[0]
            ...
            arguments = this1.params[1]
            callee = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.ECall(callee,haxpression_ExpressionTypes.clone(arguments)))
        elif (this2 == 5):
            alternate = this1.params[2]
            consequent = this1.params[1]
            test = this1.params[0]
            ...
            items = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EArray(haxpression_ExpressionTypes.clone(items)))
        elif (this2 == 7):
            items1 = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.ECompound(haxpression_ExpressionTypes.clone(items1)))
        else:
            pass
    ...
    def substitute(this1,variables):
        ...
        if (this2 == 0):
            ...
            expression = this1.params[1]
            operator = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EUnary(operator,haxpression__Expression_Expression_Impl_.toExpressionType(haxpression__Expression_Expression_Impl_.substitute(haxpression__Expression_Expression_Impl_.fromExpressionType(expression),variables))))
        elif (this2 == 3):
            right = this1.params[2]
            left = this1.params[1]
            operator1 = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EBinary(operator1,haxpression__Expression_Expression_Impl_.toExpressionType(haxpression__Expression_Expression_Impl_.substitute(haxpression__Expression_Expression_Impl_.fromExpressionType(left),variables)),haxpression__Expression_Expression_Impl_.toExpressionType(haxpression__Expression_Expression_Impl_.substitute(haxpression__Expression_Expression_Impl_.fromExpressionType(right),variables))))
        elif (this2 == 4):
            arguments = this1.params[1]
            callee = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.ECall(callee,haxpression_ExpressionTypes.substitute(arguments,variables)))
        elif (this2 == 5):
            alternate = this1.params[2]
            consequent = this1.params[1]
            test = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EConditional(haxpression__Expression_Expression_Impl_.toExpressionType(haxpression__Expression_Expression_Impl_.substitute(haxpression__Expression_Expression_Impl_.fromExpressionType(test),variables)),haxpression__Expression_Expression_Impl_.toExpressionType(haxpression__Expression_Expression_Impl_.substitute(haxpression__Expression_Expression_Impl_.fromExpressionType(consequent),variables)),haxpression__Expression_Expression_Impl_.toExpressionType(haxpression__Expression_Expression_Impl_.substitute(haxpression__Expression_Expression_Impl_.fromExpressionType(alternate),variables))))
        elif (this2 == 6):
            items = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EArray(haxpression_ExpressionTypes.substitute(items,variables)))
        elif (this2 == 7):
            items1 = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EArray(haxpression_ExpressionTypes.substitute(items1,variables)))
        else:
            pass
    ...
    def simplify(this1):
        ...
        if (this2 == 0):
            ...
            items = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EArray(haxpression_ExpressionTypes.simplify(items)))
        elif (this2 == 7):
            items1 = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.ECompound(haxpression_ExpressionTypes.simplify(items1)))
        else:
            pass
    ...
    def canEvaluate(this1):
        ...
        if (this2 == 0):
            ...
            operand = this1.params[1]
            operator = this1.params[0]
            return haxpression__Expression_Expression_Impl_.canEvaluate(haxpression__Expression_Expression_Impl_.fromExpressionType(operand))
        elif (this2 == 3):
            right = this1.params[2]
            left = this1.params[1]
            operator1 = this1.params[0]
            if haxpression__Expression_Expression_Impl_.canEvaluate(haxpression__Expression_Expression_Impl_.fromExpressionType(left)):
            ...
            arguments = this1.params[1]
            callee = this1.params[0]
            return haxpression_CallOperations.canEvaluate(callee,arguments)
        elif (this2 == 5):
            alternate = this1.params[2]
            consequent = this1.params[1]
            test = this1.params[0]
            ...
            items = this1.params[0]
            return haxpression_ExpressionTypes.canEvaluateAll(items)
        elif (this2 == 7):
            items1 = this1.params[0]
            return haxpression_ExpressionTypes.canEvaluateAll(items1)
        else:
            pass
    ...
    def evaluate(this1,variables = None):
        ...
        if (this2 == 0):
            value = this1.params[0]
            return haxpression__Value_Value_Impl_.fromValueType(value)
        elif (this2 == 1):
            name = this1.params[0]
            ...
            operand = this1.params[1]
            operator = this1.params[0]
            operandValue = haxpression__Expression_Expression_Impl_.evaluate(haxpression__Expression_Expression_Impl_.fromExpressionType(operand),variables)
            return haxpression_UnaryOperations.evaluate(operator,operandValue)
        elif (this2 == 3):
            right = this1.params[2]
            left = this1.params[1]
            operator1 = this1.params[0]
            leftValue = haxpression__Expression_Expression_Impl_.evaluate(haxpression__Expression_Expression_Impl_.fromExpressionType(left),variables)
            rightValue = haxpression__Expression_Expression_Impl_.evaluate(haxpression__Expression_Expression_Impl_.fromExpressionType(right),variables)
            return haxpression_BinaryOperations.evaluate(operator1,leftValue,rightValue)
        elif (this2 == 4):
            arguments = this1.params[1]
            callee = this1.params[0]
            return haxpression_CallOperations.evaluate(callee,haxpression_ExpressionTypes.evaluate(arguments,variables))
        elif (this2 == 5):
            alternate = this1.params[2]
            consequent = this1.params[1]
            test = this1.params[0]
            if haxpression__Value_Value_Impl_.toBool(haxpression__Expression_Expression_Impl_.evaluate(haxpression__Expression_Expression_Impl_.fromExpressionType(test),variables)):
    ...
    def isLiteral(this1,value = None):
        ...
        if (_g1.index == 0):
            tmp = _g1.params[0].index
            if (tmp == 0):
                if (_g.index == 0):
                    a = _g1.params[0].params[0]
                    b = _g.params[0]
                    return (a == b)
                else:
                    return False
    ...
    def accumulateVariables(this1,variables):
        ...
        if (this2 == 0):
            ...
            operand = this1.params[1]
            operator = this1.params[0]
            haxpression__Expression_Expression_Impl_.accumulateVariables(haxpression__Expression_Expression_Impl_.fromExpressionType(operand),variables)
        elif (this2 == 3):
            right = this1.params[2]
            left = this1.params[1]
            operator1 = this1.params[0]
            haxpression__Expression_Expression_Impl_.accumulateVariables(haxpression__Expression_Expression_Impl_.fromExpressionType(left),variables)
            haxpression__Expression_Expression_Impl_.accumulateVariables(haxpression__Expression_Expression_Impl_.fromExpressionType(right),variables)
        elif (this2 == 4):
            arguments = this1.params[1]
            callee = this1.params[0]
            ...
            haxpression_utils_Arrays.each(arguments,_hx_local_0)
        elif (this2 == 5):
            alternate = this1.params[2]
            consequent = this1.params[1]
            test = this1.params[0]
            haxpression__Expression_Expression_Impl_.accumulateVariables(haxpression__Expression_Expression_Impl_.fromExpressionType(test),variables)
            haxpression__Expression_Expression_Impl_.accumulateVariables(haxpression__Expression_Expression_Impl_.fromExpressionType(consequent),variables)
            haxpression__Expression_Expression_Impl_.accumulateVariables(haxpression__Expression_Expression_Impl_.fromExpressionType(alternate),variables)
        elif (this2 == 6):
            items = this1.params[0]
            ...
            haxpression_utils_Arrays.each(items,_hx_local_1)
        elif (this2 == 7):
            items1 = this1.params[0]
            ...
            haxpression_utils_Arrays.each(items1,_hx_local_2)
        else:
            pass
...
class haxpression_ExpressionGroup:
    ...
    def getVariables(self,includeExpressionVariables = False):
        ...
        def _hx_local_1(variables1,variable):
            ...
            if includeExpressionVariables:
                expression = _gthis.getExpression(variable)
                _g = 0
                _g1 = haxpression__Expression_Expression_Impl_.getVariables(expression)
                while (_g < len(_g1)):
    ...
    def setVariables(self,expressionOrValueMap):
        ...
        variable = expressionOrValueMap.keys()
        while variable.hasNext():
            variable1 = variable.next()
            if expressionGroup.hasVariable(variable1):
                raise _HxException(haxpression_Error((("variable " + ("null" if variable1 is None else variable1)) + " is already defined in expression group")))
            this1 = expressionGroup.variableMap
            value = expressionOrValueMap.h.get(variable1,None)
            this1.h[variable1] = value
    ...
    def setVariableValues(self,valueMap):
        ...
        expressionOrValueMap = haxpression_utils_Maps.mapValues(valueMap,_hx_local_0,haxe_ds_StringMap())
        return self.setVariables(expressionOrValueMap)
        ...
        def _hx_local_1():
            def _hx_local_0(expressionGroup,topLevelVariable):
                if expressionGroup.hasVariable(topLevelVariable):
                    expression = expressionGroup.getExpression(topLevelVariable)
    ...
    def expandExpressionForVariable(self,variable):
        ...
        while group.canExpandExpressionForVariable(variable):
            ...
            expressionVariables = haxpression__Expression_Expression_Impl_.getVariables(expression)
            def _hx_local_0(expression1,expressionVariable):
                if _gthis.hasVariable(expressionVariable):
                    _g = haxe_ds_StringMap()
                    value = haxpression__ExpressionOrValue_ExpressionOrValue_Impl_.fromExpression(_gthis.getExpression(expressionVariable))
                    _g.h[expressionVariable] = value
                    expression1 = haxpression__Expression_Expression_Impl_.substitute(expression1,_g)
                return expression1
            expression = haxpression_utils_Arrays.reduce(expressionVariables,_hx_local_0,expression)
    ...
    def evaluateExpressionForVariable(self,variable):
        ...
        value = haxpression__Expression_Expression_Impl_.evaluate(expression)
        return self.setVariable(variable,haxpression__ExpressionOrValue_ExpressionOrValue_Impl_.fromValue(value))

    def toValueMap(self):
        _gthis = self
        def _hx_local_1():
            def _hx_local_0(_hx_map,variable):
                value = _gthis.getValue(variable)
                _hx_map.h[variable] = value
                return _hx_map
    ...
    def all(self,callback):
        ...
        def _hx_local_1():
            def _hx_local_0(variable):
                tmp = _gthis.variableMap.h.get(variable,None)
                return callback(variable,tmp)
    ...
    def map(self,callback):
        ...
        while (_g < len(_g1)):
            ...
            _g = (_g + 1)
            value = callback(variable,self.variableMap.h.get(variable,None))
            newExpressionOrValueMap.h[variable] = value
    ...
    def getEvaluationInfo(self,forVariables = None):
        ...
        tmp = list(filter(_hx_local_0,result.sortedComputedVariables))
        result.sortedComputedVariables = tmp
        _g = 0
        _g1 = result.sortedComputedVariables
        while (_g < len(_g1)):
            computedVariable = (_g1[_g] if _g >= 0 and _g < len(_g1) else None)
            _g = (_g + 1)
            this1 = result.expressions
            value = group.getExpression(computedVariable)
            this1.h[computedVariable] = value
        return result
    ...
    def fromFallbackMap(_hx_map):
        def _hx_local_1(fieldId,expressions):
            ...
            return haxpression__ExpressionOrValue_ExpressionOrValue_Impl_.fromString((("COALESCE(" + ("null" if args is None else args)) + ")"))
        newMap = haxpression_utils_Maps.mapValues(_hx_map,_hx_local_1,haxe_ds_StringMap())
        return haxpression_ExpressionGroup(newMap)
...
class haxpression__ExpressionOrValue_ExpressionOrValue_Impl_:
    ...
    def toExpression(this1):
        this2 = this1.index
        if (this2 == 0):
            expression = this1.params[0]
            return expression
        elif (this2 == 1):
            value = this1.params[0]
            return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.ELiteral(haxpression__Value_Value_Impl_.toValueType(value)))
        else:
            pass
    ...
    def toValue(this1):
        ...
        if (this2 == 0):
            expression = this1.params[0]
            return haxpression__Expression_Expression_Impl_.evaluate(expression)
        elif (this2 == 1):
            value = this1.params[0]
            return value
        else:
    ...
    def toDynamic(this1):
        ...
        if (this2 == 0):
            expression = this1.params[0]
            return haxpression__Expression_Expression_Impl_.toDynamic(expression)
        elif (this2 == 1):
            value = this1.params[0]
            return haxpression__Value_Value_Impl_.toDynamic(value)
        else:
            pass
...
class haxpression_Parser:
        ...
        while (self.index < self.length):
            ...
            if ((charCode == haxpression_utils_Chars.SEMICOLON_CODE) or ((charCode == haxpression_utils_Chars.COMMA_CODE))):
                ...
                if (expression is not None):
                    _this = self.expressions
                    _this.append(expression)
    ...
    def gobbleBinaryOperator(self):
        ...
        while (toCheckLength > 0):
            ...
            toCheck = HxString.substr(toCheck,0,toCheckLength)
        return None
    ...
    def gobbleBinaryExpression(self):
        ...
        left = None
        right = None
        left1 = self.gobbleToken()
        binaryOperator1 = self.gobbleBinaryOperator()
        if (binaryOperator1 is None):
            return left1
        binaryOperatorInfo = _hx_AnonObject({'operator': binaryOperator1, 'precedence': haxpression_BinaryOperations.getOperatorPrecedence(binaryOperator1)})
        right1 = self.gobbleToken()
        if (right1 is None):
            raise _HxException(haxpression_Error((("expected expression after binary operator: \"" + ("null" if binaryOperator1 is None else binaryOperator1)) + "\""),self.inputString,self.index))
        stack1 = [left1, binaryOperatorInfo, right1]
        while True:
            binaryOperator1 = self.gobbleBinaryOperator()
            if (not ((binaryOperator1 is not None))):
                break
            precedence = haxpression_BinaryOperations.getOperatorPrecedence(binaryOperator1)
            if (precedence == 0):
                break
            binaryOperatorInfo = _hx_AnonObject({'operator': binaryOperator1, 'precedence': precedence})
            while ((len(stack1) > 2) and ((precedence <= Reflect.field(python_internal_ArrayImpl._get(stack1, (len(stack1) - 2)),"precedence")))):
                right1 = (None if ((len(stack1) == 0)) else stack1.pop())
                binaryOperator1 = Reflect.field(((None if ((len(stack1) == 0)) else stack1.pop())),"operator")
                left1 = (None if ((len(stack1) == 0)) else stack1.pop())
                expression1 = haxpression_ExpressionType.EBinary(binaryOperator1,haxpression__Expression_Expression_Impl_.toExpressionType(left1),haxpression__Expression_Expression_Impl_.toExpressionType(right1))
                stack1.append(expression1)
            expression = self.gobbleToken()
            if (expression is None):
                raise _HxException(haxpression_Error((("expected expression after binary operator: \"" + ("null" if binaryOperator1 is None else binaryOperator1)) + "\""),self.inputString,self.index))
            stack1.append(binaryOperatorInfo)
            stack1.append(expression)
        i = (len(stack1) - 1)
        expression = (stack1[i] if i >= 0 and i < len(stack1) else None)
        while (i > 1):
            expression = haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EBinary(Reflect.field(python_internal_ArrayImpl._get(stack1, (i - 1)),"operator"),python_internal_ArrayImpl._get(stack1, (i - 2)),haxpression__Expression_Expression_Impl_.toExpressionType(expression)))
            i = (i - 2)
        return expression
    ...
    def gobbleNumericLiteral(self):
        ...
        while ((self.index < self.length) and haxpression_utils_Chars.isDecimalDigit(self.charCodeAt(self.index))):
            def _hx_local_2():
                ...
                _hx_local_0.index = (_hx_local_1 + 1)
                return _hx_local_1
            numberString1 = self.charAt(_hx_local_2())
            numberString = (("null" if numberString is None else numberString) + ("null" if numberString1 is None else numberString1))
        if (self.charCodeAt(self.index) == haxpression_utils_Chars.PERIOD_CODE):
            def _hx_local_6():
                ...
                return _hx_local_5
            numberString2 = self.charAt(_hx_local_6())
            numberString = (("null" if numberString is None else numberString) + ("null" if numberString2 is None else numberString2))
            while ((self.index < self.length) and haxpression_utils_Chars.isDecimalDigit(self.charCodeAt(self.index))):
                def _hx_local_10():
                    _hx_local_8 = self
                    ...
                    return _hx_local_9
                numberString3 = self.charAt(_hx_local_10())
                numberString = (("null" if numberString is None else numberString) + ("null" if numberString3 is None else numberString3))
        ...
        if ((char == "e") or ((char == "E"))):
            def _hx_local_14():
                ...
                return _hx_local_13
            numberString4 = self.charAt(_hx_local_14())
            numberString = (("null" if numberString is None else numberString) + ("null" if numberString4 is None else numberString4))
            char = self.charAt(self.index)
            if ((char == "+") or ((char == "-"))):
                def _hx_local_18():
                    _hx_local_16 = self
                    ...
                    return _hx_local_17
                numberString5 = self.charAt(_hx_local_18())
                numberString = (("null" if numberString is None else numberString) + ("null" if numberString5 is None else numberString5))
            while ((self.index < self.length) and haxpression_utils_Chars.isDecimalDigit(self.charCodeAt(self.index))):
                def _hx_local_22():
                    _hx_local_20 = self
                    ...
                    return _hx_local_21
                numberString6 = self.charAt(_hx_local_22())
                numberString = (("null" if numberString is None else numberString) + ("null" if numberString6 is None else numberString6))
    ...
    def gobbleArguments(self,terminationCharCode):
        ...
        if (not sawTermination):
            char = "".join(map(chr,[terminationCharCode]))
            raise _HxException(haxpression_Error((("expected termination character: \"" + ("null" if char is None else char)) + "\""),self.inputString,self.index))
        return expressions

    def gobbleVariable(self):
        charCode = self.charCodeAt(self.index)
        expression = None
        if (charCode == haxpression_utils_Chars.OPEN_PAREN_CODE):
            expression = self.gobbleGroup()
        else:
            expression = self.gobbleIdentifier()
        self.gobbleSpaces()
        if (self.index < self.length):
            charCode = self.charCodeAt(self.index)
            while ((self.index < self.length) and ((((charCode == haxpression_utils_Chars.PERIOD_CODE) or ((charCode == haxpression_utils_Chars.OPEN_BRACKET_CODE))) or ((charCode == haxpression_utils_Chars.OPEN_PAREN_CODE))))):
                ...
                if (charCode == haxpression_utils_Chars.PERIOD_CODE):
                    ...
                    def _hx_local_2(expression1):
                        return haxpression__Expression_Expression_Impl_.toExpressionType(expression1)
                    arguments = list(map(_hx_local_2,self.gobbleArguments(haxpression_utils_Chars.CLOSE_PAREN_CODE)))
                    expression = haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.ECall(callee,arguments))
                self.gobbleSpaces()
                charCode = self.charCodeAt(self.index)
        return expression
    ...
    def gobbleArray(self):
        ...
        def _hx_local_2(expression):
            return haxpression__Expression_Expression_Impl_.toExpressionType(expression)
        items = list(map(_hx_local_2,self.gobbleArguments(haxpression_utils_Chars.CLOSE_BRACKET_CODE)))
        return haxpression__Expression_Expression_Impl_.fromExpressionType(haxpression_ExpressionType.EArray(items))

    @staticmethod
    def parse(input):
        parser = haxpression_Parser(input)
...
class haxpression_UnaryOperations:
    ...
    def addOperator(operator,operation):
        this1 = haxpression_UnaryOperations.map
        value = _hx_AnonObject({'operation': haxpression_UnaryOperations.wrapOperation(operation)})
        this1.h[operator] = value
...
class haxpression_python_PythonExports:
    ...
    __slots__ = ()
    _hx_statics = ["loggingEnabled", "getEvaluationInfo", "parseToObject", "parseEvaluate", "expressionToDict", "traceMeasure"]

    @staticmethod
    def getEvaluationInfo(mappings,requestedFieldIds):
        mappingsObj = None
        if haxpression_python_PythonExports.loggingEnabled:
            ...
            mappingsObj = python_Lib.dictToAnon(mappings)
        mappingsObj1 = mappingsObj
        ...
        if haxpression_python_PythonExports.loggingEnabled:
            ...
            def _hx_local_2():
                _g = 0
                _g1 = python_Boot.fields(mappingsObj1)
                while (_g < len(_g1)):
                    fieldId = (_g1[_g] if _g >= 0 and _g < len(_g1) else None)
                    _g = (_g + 1)
                    fieldExpressions = Reflect.field(mappingsObj1,fieldId)
            ...
            _g2 = 0
            _g11 = python_Boot.fields(mappingsObj1)
            while (_g2 < len(_g11)):
                fieldId1 = (_g11[_g2] if _g2 >= 0 and _g2 < len(_g11) else None)
                _g2 = (_g2 + 1)
                fieldExpressions1 = Reflect.field(mappingsObj1,fieldId1)
                value1 = list(map(haxpression__ExpressionOrValue_ExpressionOrValue_Impl_.fromString,fieldExpressions1))
                fieldIdToExpressionsMap.h[fieldId1] = value1
        ...
        if haxpression_python_PythonExports.loggingEnabled:
            ...
            expressionGroup = haxe_Timer.measure(_hx_local_4,_hx_AnonObject({'fileName': "PythonExports.hx", 'lineNumber': 126, 'className': "haxpression.python.PythonExports", 'methodName': "traceMeasure"}))
        else:
            expressionGroup = haxpression_ExpressionGroup.fromFallbackMap(fieldIdToExpressionsMap)
        expressionGroup1 = expressionGroup
        evaluationInfo = None
        if haxpression_python_PythonExports.loggingEnabled:
            ...
            def _hx_local_5():
                return expressionGroup1.getEvaluationInfo(requestedFieldIds)
            evaluationInfo = haxe_Timer.measure(_hx_local_5,_hx_AnonObject({'fileName': "PythonExports.hx", 'lineNumber': 126, 'className': "haxpression.python.PythonExports", 'methodName': "traceMeasure"}))
        else:
            evaluationInfo = expressionGroup1.getEvaluationInfo(requestedFieldIds)
        evaluationInfo1 = evaluationInfo
        ...
        if haxpression_python_PythonExports.loggingEnabled:
            ...
            def _hx_local_6():
                key = evaluationInfo1.expressions.keys()
                while key.hasNext():
                    key1 = key.next()
                    value2 = haxpression_python_PythonExports.expressionToDict(evaluationInfo1.expressions.h.get(key1,None))
                    ...
                    setattr(expressionAstsObj,tmp,value2)
            haxe_Timer.measure(_hx_local_6,_hx_AnonObject({'fileName': "PythonExports.hx", 'lineNumber': 126, 'className': "haxpression.python.PythonExports", 'methodName': "traceMeasure"}))
        else:
            key2 = evaluationInfo1.expressions.keys()
            while key2.hasNext():
                key3 = key2.next()
                value3 = haxpression_python_PythonExports.expressionToDict(evaluationInfo1.expressions.h.get(key3,None))
                tmp1 = (("_hx_" + key3) if ((key3 in python_Boot.keywords)) else (("_hx_" + key3) if (((((len(key3) > 2) and ((ord(key3[0]) == 95))) and ((ord(key3[1]) == 95))) and ((ord(key3[(len(key3) - 1)]) != 95)))) else key3))
                setattr(expressionAstsObj,tmp1,value3)
        result = _hx_AnonObject({'expressionAsts': python_Lib.anonToDict(expressionAstsObj), 'externalVariables': evaluationInfo1.externalVariables, 'sortedComputedVariables': evaluationInfo1.sortedComputedVariables})
        pythonResult = None
        if haxpression_python_PythonExports.loggingEnabled:
            ...
            pythonResult = haxe_Timer.measure(_hx_local_7,_hx_AnonObject({'fileName': "PythonExports.hx", 'lineNumber': 126, 'className': "haxpression.python.PythonExports", 'methodName': "traceMeasure"}))
        else:
            pythonResult = python_Lib.anonToDict(result)
        pythonResult1 = pythonResult
        return pythonResult1
    ...
    def parseEvaluate(s,_hx_dict):
        ...
        while (_g < len(_g1)):
            ...
            _g = (_g + 1)
            value = haxpression__Value_Value_Impl_.fromDynamic(Reflect.field(o,field))
    ...
    def expressionToDict(expression):
        ...
        if (_g1 == 0):
            value = _g.params[0]
            this1 = value
            tmp = _hx_AnonObject({'type': "Literal", 'value': haxpression__Value_Value_Impl_.toDynamic(this1)})
        elif (_g1 == 1):
            name = _g.params[0]
            tmp = _hx_AnonObject({'type': "Identifier", 'name': name})
        elif (_g1 == 2):
            operand = _g.params[1]
            operator = _g.params[0]
            tmp = _hx_AnonObject({'type': "Unary", 'operator': operator, 'operand': haxpression_python_PythonExports.expressionToDict(haxpression__Expression_Expression_Impl_.fromExpressionType(operand))})
        elif (_g1 == 3):
            right = _g.params[2]
            left = _g.params[1]
            operator1 = _g.params[0]
            tmp = _hx_AnonObject({'type': "Binary", 'operator': operator1, 'left': haxpression_python_PythonExports.expressionToDict(haxpression__Expression_Expression_Impl_.fromExpressionType(left)), 'right': haxpression_python_PythonExports.expressionToDict(haxpression__Expression_Expression_Impl_.fromExpressionType(right))})
        elif (_g1 == 4):
            arguments = _g.params[1]
            callee = _g.params[0]
            def _hx_local_0(arg):
                return haxpression_python_PythonExports.expressionToDict(haxpression__Expression_Expression_Impl_.fromExpressionType(arg))
            tmp = _hx_AnonObject({'type': "Call", 'callee': callee, 'arguments': list(map(_hx_local_0,arguments))})
        elif (_g1 == 5):
            alternate = _g.params[2]
            consequent = _g.params[1]
            test = _g.params[0]
            tmp = _hx_AnonObject({'type': "Conditional", 'test': haxpression_python_PythonExports.expressionToDict(haxpression__Expression_Expression_Impl_.fromExpressionType(test)), 'consequent': haxpression_python_PythonExports.expressionToDict(haxpression__Expression_Expression_Impl_.fromExpressionType(consequent)), 'alternate': haxpression_python_PythonExports.expressionToDict(haxpression__Expression_Expression_Impl_.fromExpressionType(alternate))})
        elif (_g1 == 6):
            items = _g.params[0]
            ...
            tmp = _hx_AnonObject({'type': "Array", 'items': list(map(_hx_local_1,items))})
        elif (_g1 == 7):
            items1 = _g.params[0]
            ...
            tmp = _hx_AnonObject({'type': "Compound", 'items': list(map(_hx_local_2,items1))})
        else:
            pass
    ...
    def mapValues(_hx_map,mapper,seed):
        def _hx_local_1():
            def _hx_local_0(key,acc):
                valueIn = _hx_map.get(key)
                valueOut = mapper(key,valueIn)
...
class python_Lib:
    ...
    __slots__ = ()
    _hx_statics = ["println", "dictToAnon", "anonToDict"]
...
haxpression_python_PythonExports.loggingEnabled = False
